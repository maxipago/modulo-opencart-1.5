...
$prefix = '';
$style = '
.maxipago-tab .form-group {margin: 10px 0;}
.col-sm-2 {width: 150px;}
.maxipago-tab .pull-left{float: left;}
.maxipago-tab .hide{display: none;}
#maxipago-form .list-group-item{margin:20px 0}
.maxipago-tab .required {color: #000000;}
';
?>
                    ...
                    <div class="radio maxipago-cc list-group-item">
                        ...
                        <div class="maxipago-tab-cc maxipago-tab panel panel-default" style="display:none;">
                            ...
                            <fieldset id="payment-maxipago-cc" class="panel-body">
                                            ...
                                            <div class="pull-left">
                                                <label class="mp-card-brand">
                                                    <input id="input-cc-brand-<?php echo $brand;?>"
                                                           ...
                                                           name="cc_brand"
                                                           value="<?php echo $card;?>"/>
                                                    <img src="<?php echo $base_url;?>image/payment/maxipago/brands/<?php echo $brand;?>.png" alt="<?php echo $card;?>" />
                                                </label>
                                            </div>
                                        <?php endforeach; ?>
                                ...
                                <div class="form-group required">
                                    <label class="col-sm-2 control-label" for="input-cc-cpf">
                                        <?php echo $entry_cpf_number; ?>
                                    </label>
                                    <div class="col-sm-10">
                                        <input type="text" name="cc_cpf" id="input-cc-cpf" class="form-control cpf" />
                                    </div>
                                </div>
...
//        }
    ...
    maxipago.maxipagoRequest = function() {
        ...
        $.ajax({
            url: 'index.php?route=<?php echo $prefix;?>payment/maxipago/transaction',
            data: formData,
            type: 'POST',
            dataType: 'JSON',
            beforeSend: function() {
            ...
            success: function(orderData){
                ...
                $.ajax({
                    url: 'index.php?route=<?php echo $prefix;?>payment/maxipago/confirm',
                    data: orderData,
                    type: 'POST',
...
<style>
    ...
    #payment-maxipago-redepay > div,
    #payment-maxipago-cc > div,
    #payment-maxipago-dc > div,
    #payment-maxipago-eft > div {
        display:flex;
    }
